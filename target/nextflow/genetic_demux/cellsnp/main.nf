// cellsnp fix_integration_test_build
// 
...
meta = [
  ...
  "functionality" : {
    ...
    "version" : "fix_integration_test_build",
    "authors" : [
      {
        "name" : "Xichen Wu",
        "roles" : [
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/genetic_demux/cellsnp/"
      }
    ],
  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "wget https://github.com/samtools/htslib/releases/download/1.16/htslib-1.16.tar.bz2 -O htslib.tar.bz2 && tar -xjvf htslib.tar.bz2 && cd htslib-1.16 && make && make install"
          ]
        },
        {
          "type" : "docker",
          "run" : [
            "git clone https://github.com/single-cell-genetics/cellsnp-lite.git && cd cellsnp-lite && autoreconf -iv && ./configure --with-htslib=/htslib-1.16 && make && make install"
          ]
        }
      ]
    },
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/genetic_demux/cellsnp/config.vsh.yaml",
    "platform" : "nextflow",
    "output" : "/home/runner/work/openpipeline/openpipeline/target/nextflow/genetic_demux/cellsnp",
    "viash_version" : "0.8.2",
    "git_commit" : "4f02fd6c2e8f3c33b2e596d438163975ec696b02",
    "git_remote" : "https://github.com/openpipelines-bio/openpipeline",
    "git_tag" : "0.2.0-1498-g4f02fd6c2e"
  }
}'''))
]
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/genetic_demux_cellsnp",
    "tag" : ""
  },
  "label" : [
    "highmem",
