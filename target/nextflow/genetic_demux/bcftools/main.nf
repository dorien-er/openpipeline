// bcftools 461-rename-workflows_build
// 
...
meta = [
    ...
    "resources" : [
      {
        ...
        "path" : "script.sh",
        "is_executable" : true,
        "parent" : "file:/home/runner/work/openpipeline/openpipeline/src/genetic_demux/bcftools/"
      }
    ],
  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "wget https://github.com/samtools/bcftools/releases/download/1.16/bcftools-1.16.tar.bz2 -O bcftools.tar.bz2 && tar -xjvf bcftools.tar.bz2 && cd bcftools-1.16 && make prefix=/usr/local install"
          ]
        }
      ]
    },
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/genetic_demux/bcftools/config.vsh.yaml",
    "platform" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_CONCAT+x} ]; then echo "${VIASH_PAR_CONCAT}" | sed "s#'#'\\"'\\"'#g;s#.*#par_concat='&'#" ; else echo "# par_concat="; fi )
$( if [ ! -z ${VIASH_PAR_FILTER+x} ]; then echo "${VIASH_PAR_FILTER}" | sed "s#'#'\\"'\\"'#g;s#.*#par_filter='&'#" ; else echo "# par_filter="; fi )
$( if [ ! -z ${VIASH_PAR_FILTER_QUAL+x} ]; then echo "${VIASH_PAR_FILTER_QUAL}" | sed "s#'#'\\"'\\"'#g;s#.*#par_filter_qual='&'#" ; else echo "# par_filter_qual="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/genetic_demux_bcftools",
    "tag" : "main_build"
  },
  "label" : [
    "midmem",
