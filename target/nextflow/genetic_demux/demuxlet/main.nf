// demuxlet fix_integration_test_build
// 
...
meta = [
  ...
  "platforms" : [
    {
      ...
      "setup" : [
        ...
        },
        {
          "type" : "docker",
          "run" : [
            "git clone https://github.com/samtools/htslib.git /tmp/htslib && cd /tmp/htslib && git submodule update --init --recursive && autoreconf -i && ./configure --prefix=/usr/local/ && make && make install"
          ]
        },
        {
          "type" : "docker",
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/genetic_demux/demuxlet/config.vsh.yaml",
    "platform" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openpipelines-bio/genetic_demux_demuxlet",
    "tag" : ""
  },
  "label" : [
    "midmem",
