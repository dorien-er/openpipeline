// cellranger_postprocessing fix_integration_test_build
// 
...
meta = [
  ...
  "info" : {
    "config" : "/home/runner/work/openpipeline/openpipeline/src/workflows/ingestion/cellranger_postprocessing/config.vsh.yaml",
    "platform" : "nextflow",
...
def innerWorkflowFactory(args) {
  return cellranger_postprocessing
}
